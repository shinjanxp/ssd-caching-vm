...
sudo lvcreate -y -l 100%FREE -n lv_origin CS695 /dev/sdb1
sudo lvcreate -y -L 200G -n lv_cache CS695 /dev/sdc1
sudo lvcreate -y -L 5G -n lv_cache_meta CS695 /dev/sdc1
